...
public class Gestor {
    ...
    private static ConfiguracionHibernate configuracionHibernate;
    protected List<String> packages;
    protected List<Class> clases;
    protected Session sesion;

    public Gestor() {
        configuracionHibernate = new ConfiguracionHibernate();
    }
    ...
    public ConfiguracionHibernate getHu() {
        if (configuracionHibernate != null) {
            return configuracionHibernate;
        } else {
            configuracionHibernate = new ConfiguracionHibernate();
            return configuracionHibernate;
        }
    ...
    public static void setHu(ConfiguracionHibernate configuracionHibernate) {
        Gestor.configuracionHibernate = configuracionHibernate;
    }
